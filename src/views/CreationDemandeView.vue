    ...
    <ion-header>
      <ion-toolbar>
        ...
        <ion-buttons slot="end">
          <button class="annuler-btn" type="button" @click="$emit('close')">Annuler</button>
        </ion-buttons>
      </ion-toolbar>
    </ion-header>
      ...
      <div class="form-content">
        ...
        <div class="form-section">
          <div class="section-header">
            ...
            <h3 class="section-title">Médicaments <span class="required">*</span></h3>
          </div>
          ...
          <button class="add-med-btn" type="button" @click="ajouterMed">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        <div class="form-section">
          <div class="section-header">
            ...
            <h3 class="section-title">Adresse de livraison <span class="required">*</span></h3>
          </div>
        ...
        <div class="form-section">
          <div class="section-header">
            ...
            <h3 class="section-title">Ordonnance <span class="required">*</span></h3>
          </div>
